...
public:
    ...
    double intersect(const Ray& ray) const {
        ...
        vec3 e1 = v1 - v0;
        vec3 e2 = v2 - v0;
        vec3 b = vec3(ray.o.x, ray.o.y, ray.o.z) - v0;
        mat3 A(vec3(-ray.d.x, -ray.d.y, -ray.d.z), e1, e2 );
...
public:
    ...
    double intersect(const Ray& ray) const {
        double b = glm::dot((ray.o-vec4(c,1))*2.f,ray.d);
        double c_ = glm::dot(ray.o-vec4(c,1), ray.o-vec4(c,1)) - (r*r);
